...
const mod = new Mod(
	"Polytone",
	"MehVahdJukaar",
	"Multipurpose Visual Customization mod: tweak Colors, Colormaps, Lightmaps, Sounds, Gui Elements, Biome Effects, Particles and more. Supports old Optifine formats",
)
