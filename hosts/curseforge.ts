	...
	(width, height) =>
		html.svg({
			attributes: {
				...
				src: "https://www.curseforge.com/Content/2-0-8083-18015/Skins/CurseForge/images/anvil.svg",
				width: `${width}`,
				height: `${height}`,
			},
			style: {
