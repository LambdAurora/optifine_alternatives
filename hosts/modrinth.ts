...
import { Host } from "../build_logic/host.ts";
		...
		html.svg({
			...
			children: [
				html.create_element("path")
					...
					.with_attr(
						"d",
						"M159.07,89.29A70.94,70.94,0,1,0,20,63.52H32A58.78,58.78,0,0,1,145.23,49.93l-11.66,3.12a46.54,46.54,0,0,0-29-26.52l-2.15,12.13a34.31,34.31,0,0,1,2.77,63.26l3.19,11.9a46.52,46.52,0,0,0,28.33-49l11.62-3.1A57.94,57.94,0,0,1,147.27,85Z",
					),
				html.create_element("path")
					.with_attr("fill-rule", "evenodd")
					.with_attr("fill", "#1bd96a")
